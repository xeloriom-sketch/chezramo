...
export const MENU_DATA: MenuItem[] = [
  {title:'Kebab',description:'Pain rond, veau maison, crudités — Menu +3 €',price:'9,00',menu_price:'12,00',category:'Sandwichs Vedettes'},
  {title:'Kebab Frites',description:'Viande et frites servies dans le pain',price:'9,50',menu_price:'',category:'Sandwichs Vedettes'},
  {title:'Kebab Géant',description:'Double portion de veau maison — Menu +2 €',price:'15,00',menu_price:'17,00',category:'Sandwichs Vedettes'},
  ...
  {title:'Escalope',description:'Filet de poulet pané maison — Menu +3 €',price:'9,00',menu_price:'12,00',category:'Nos Spécialités'},
  ...
  {title:'Assiette Kebab',description:'Veau maison servi à l\'assiette',price:'15,00',menu_price:'',category:'Assiettes Gourmet'},
  {title:'Assiette Escalope',description:'Poulet pané ou grillé',price:'15,00',menu_price:'',category:'Assiettes Gourmet'},
  {title:'Assiette Kofte',description:'Boulettes maison grillées',price:'15,00',menu_price:'',category:'Assiettes Gourmet'},
  ...
  {title:'Qofte x5',description:'5 pièces de viande hachée grillées maison',price:'9,00',menu_price:'',category:'Qofte Grillées'},
  {title:'Qofte x7',description:'7 pièces de viande hachée grillées maison',price:'11,00',menu_price:'',category:'Qofte Grillées'},
  {title:'Qofte x10',description:'10 pièces de viande hachée grillées maison',price:'13,00',menu_price:'',category:'Qofte Grillées'},
  ...
  {title:'Salade Shope',description:'Saladerie fraîche maison',price:'6,00',menu_price:'',category:'Salades Fraîches'},
  {title:'Burek Fromage',description:'Feuilleté maison au fromage',price:'3,50',menu_price:'',category:'Salades & Burek'},
  ...
  {title:'Fli - Flija',description:'Fli traditionnel fait maison',price:'4,00',menu_price:'',category:'Salades & Burek'},
  {title:'Trilece',description:'Dessert traditionnel au lait',price:'3,50',menu_price:'',category:'Desserts'},
  {title:'Tiramisu',description:'Tiramisu maison',price:'3,50',menu_price:'',category:'Desserts'},
  ...
  {title:'Barquette Viande',description:'Portion de veau 100% maison',price:'10,00',menu_price:'',category:'Accompagnements & Sauces'},
