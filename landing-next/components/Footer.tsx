        ...
        <div>
          ...
          <div className="space-y-2.5 text-sm">
            ...
            <a
              ...
              className="flex items-center gap-3 min-h-[44px] text-brand/85 hover:text-brand transition-colors group"
              itemProp="telephone"
            >
          ...
          <div className="mt-4 flex gap-3">
            <a href="https://www.facebook.com/chezramolagnieu" target="_blank" rel="noopener noreferrer" aria-label="Facebook Chez Ramo"
               className="w-11 h-11 rounded-full border-2 border-brand/30 flex items-center justify-center text-brand hover:bg-brand hover:text-cream transition">
